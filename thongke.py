        ...
        if not selected_years:
            ...
            if total_rec_df.empty:
                ...
                if is_only_gd:
                    ...
                    # 🌟 Thêm các tiêu chí riêng biệt mới vào danh sách gom nhóm
