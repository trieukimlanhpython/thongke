                    ...
                    if not selected_years:
                        ...
                        if total_rec_df.empty:
                            ...
                            if is_only_gd:
                                ...
                                # ==========================================
                                st.markdown("##### 📚 Bảng tổng hợp môn học theo từng Giảng viên")
                                ...
                                # ==========================================
                                st.markdown("##### 👥 Bảng tổng hợp môn học theo từng Giảng viên từng năm học")
                                st.caption("💡 Để biết GV nào, năm nào đã giảng những môn nào")
                                ...
                                if 'df_grouped_stat' in locals() and not df_grouped_stat.empty and "Năm học" in df_grouped_stat.columns and opt_y:
                                    ...
                                    if not df_year_summary.empty:
                                        ...
                                        with col_y1:
                                            ...
                                            num_years = len(df_year_summary)
                                            ax_y1.tick_params(axis="x", rotation=45 if num_years > 4 else 0)
                                            ax_y1.grid(axis="y", linestyle="--", alpha=0.5)
                                            st.pyplot(fig_y1, bbox_inches="tight")
                                        ...
                                        with col_y2:
                                            ...
                                            ax_y2.tick_params(axis="x", rotation=45 if num_years > 4 else 0)
                                            ax_y2.grid(axis="y", linestyle="--", alpha=0.5)
                                            st.pyplot(fig_y2, bbox_inches="tight")
